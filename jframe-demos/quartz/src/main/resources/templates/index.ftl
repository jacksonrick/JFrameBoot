...
<div id="test">
    ...
    <el-dialog title="添加任务" :visible.sync="dialogFormVisible">
        <el-form :model="form">
            <el-form-item label="任务名称(类)" label-width="120px" style="width:50%">
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            loadData: function (pageNum, pageSize) {
                this.$http.get('/queryJob?' + 'pageNum=' + pageNum + '&pageSize=' + pageSize).then(function (res) {
                    console.log(res)
            ...
            handleDelete: function (index, row) {
                this.$http.post('/delJob', {
                    "className": row.job_NAME,
                    "groupName": row.job_GROUP
            ...
            add: function () {
                this.$http.post('/addJob', {
                    "className": this.form.jobName,
                    "groupName": this.form.jobGroup,
            ...
            update: function () {
                ...
                ('/rescheduleJob',
                        {
                            "className": this.updateform.jobName,
                            "groupName": this.updateform.jobGroup,
