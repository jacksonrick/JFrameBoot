 ...
 *
 * @author auto create
 * @since 1.0, 2017-06-05 10:33:17
 */
public class AlipayOfflineProviderUseractionRecordModel extends AlipayObject {

	private static final long serialVersionUID = 5668485182626261835L;
...
值意义：alipay：支付宝；weixin：微信；isv：isv自己的系统未通过第三方点菜，other：其他;
当前订单的创建来源，比如支付宝扫码创建或微信扫码创建或通过自己的系统用户点菜后创建，则传入对应英文。
	 */
