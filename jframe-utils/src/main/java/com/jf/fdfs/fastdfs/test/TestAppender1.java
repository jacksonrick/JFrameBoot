        ...
        try {
  		...
  		*/
            ...
            if (appender_file_id != null) {
                ...
                if (ClientGlobal.tracker_http_port != 80) {
                    file_url += ":" + ClientGlobal.tracker_http_port;
                }
                file_url += "/" + appender_file_id;
                if (ClientGlobal.anti_steal_token) {
                    ts = (int) (System.currentTimeMillis() / 1000);
                    token = ProtoCommon.getToken(appender_file_id, ts, ClientGlobal.secret_key);
