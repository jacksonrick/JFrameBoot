...
jq.fn.imgslide = function(can) {
	...
	var xtqhnum = 0;
	var popnum = 0;
	jq(can.pic).find('ul').width(picnum * picw).height(pich); //picnum * 
	jq(can.pnum).find('ul').width(picminnum * picminw).height(picminh); //picminnum * 
