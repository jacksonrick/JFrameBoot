 ...
 */
@Configuration
@ConditionalOnProperty(name = "app.db.db2.enabled", havingValue = "true")
@MapperScan(basePackages = DbTwoConfig.mapperPackage, sqlSessionFactoryRef = "db2SqlSessionFactory")
@EnableTransactionManagement
public class DbTwoConfig {

    private Logger logger = LoggerFactory.getLogger(DbTwoConfig.class);

    public final static String mapperPackage = "com.jf.db2";
    public final static String xmlMapperLocation = "classpath:com/jf/db2/xml/*.xml";
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("db2DataSource") DataSource dataSource) {
        try {
            ...
            logger.error("DB [2] sqlSessionFactory create error!", e);
            return null;
        }
    }
